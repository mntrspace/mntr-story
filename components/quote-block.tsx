...
export function QuoteBlock({
  ...
  return (
    <figure className={spotlight ? "text-center" : ""}>
      <blockquote
        className={
          spotlight
      ...
      {hasStory ? (
        <details className="story mt-6">
          ...
          <div
            className={`mt-5 space-y-5 border-l border-border pl-5 text-left ${
              spotlight ? "mx-auto max-w-xl" : ""
            }`}
          >
            {entry.origin ? (
              <div>
